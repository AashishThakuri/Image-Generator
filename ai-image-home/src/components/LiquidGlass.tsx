...
export const LiquidGlass = ({
    ...
    const handleToggleExpansion = (e: React.MouseEvent<HTMLElement>) => {
    ...
    const MotionComponent = draggable || expandable || (props as any).layoutId ? motion.div : 'div';
    ...
    return (
        <>
            ...
            >
                ...
                {/* Content */}
                <div suppressHydrationWarning className={cn('relative z-30')}>{children}</div>
            </MotionComponent>
        </>
    );
};
